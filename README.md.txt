...
*   **International Plan Misalignment:** A critical segment of users pays for the *International Plan* option but has **0 minutes** of actual international usage, leading to a high sense of poor value and fast cancellation.
...
*High-level summary of financial impacts, geographic losses, and contract risk.*
![Executive Churn Overview](visuals/Overview.jpg)

### 2. Customer Demographics & Segmentation
*Exploration of who is leaving across age brackets, group offerings, and gender.*
![Customer Demographics & Segmentation](visuals/Demographic.jpg)

### 3. Plans, Options & Usage Analysis
*Nuance discovery cross-referencing data consumption, payment flows, and option usage.*
![Plans, Options & Usage Analysis](visuals/Plans.jpg)

### 4. Customer Churn Diagnostic & Deep Dive
*Interactive Decomposition Tree tracking exact qualitative reasons and support thresholds.*
